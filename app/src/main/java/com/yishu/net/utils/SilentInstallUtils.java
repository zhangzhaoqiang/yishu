...
public final class SilentInstallUtils {
     ...
     * @return 是否安装成功
     */
    public static boolean installByShell(File file, boolean isRoot) {
        String cmd = "pm install -r '" + file.getAbsolutePath() + "'";
        return executeShell(cmd, isRoot) || executeShell(cmd, !isRoot);
    }

    public static boolean uninstallByShell(String packageName, boolean isRoot) {
        String cmd = "pm uninstall '" + packageName + "'";
        return executeShell(cmd, isRoot) || executeShell(cmd, !isRoot);
    }


    public static boolean executeShell(String cmd, boolean isRoot) {
     ...
     */
    public static boolean installByReflect(Context context, File file) throws InterruptedException {
     ...
     */
    public static boolean uninstallByReflect(Context context, String packageName) throws InterruptedException {
    ...
    @RequiresPermission(Manifest.permission.INSTALL_PACKAGES)
    public static boolean installByPackageInstaller(Context context, File file, AppUtils.AppInfo apkInfo) throws InterruptedException {
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @RequiresPermission(Manifest.permission.DELETE_PACKAGES)
    public static boolean uninstallByPackageInstaller(Context context, String packageName) {
    ...
    @Nullable
    public static Method getInstallPackageMethod() {
    ...
    @Nullable
    public static Method getDeletePackageMethod() {
